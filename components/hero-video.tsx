  ...
  return (
    <>
      ...
      <button
        ...
        onClick={toggleSound}
        className="absolute bottom-4 right-3 z-20 flex min-h-10 w-[calc(50vw-1rem)] max-w-[10.5rem] items-center justify-center rounded-full border border-white/20 bg-black/45 px-2.5 py-2 text-center font-[var(--font-heading)] text-[9px] font-semibold uppercase leading-tight tracking-[0.12em] text-stone-100 shadow-[0_14px_40px_rgba(0,0,0,0.35)] backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:border-white/35 hover:bg-black/65 min-[380px]:text-[10px] min-[420px]:bottom-5 min-[420px]:right-4 min-[420px]:min-h-11 min-[420px]:w-auto min-[420px]:max-w-none min-[420px]:px-4 min-[420px]:text-[11px] min-[420px]:tracking-[0.16em] sm:bottom-8 sm:right-8 sm:min-h-12 sm:px-5 sm:py-2.5 sm:text-xs md:px-6 md:py-3 md:text-sm md:tracking-[0.18em] lg:bottom-10 lg:right-10"
      >
